...
- `README.md` told people to run `uv sync --extra cloud` and
  `--extra notebooks`; neither exists, so both commands failed. It now documents
  the install as it is, and the catalog file source matching needs.
