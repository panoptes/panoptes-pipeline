...
from piaa.utils.helpers import get_observation_blobs, unpack_blob, get_stars
...
def main(seq_id):
    ...
    with concurrent.futures.ProcessPoolExecutor(max_workers=4) as executor:
        ...
        np.savez_compressed(os.path.join(working_dir, 'cube'),
                            list(executor.map(calibrate_image, calibrate_args)))
